...
public class HashCodeAndEqualsImplementationTest {
    ...
    public static void main(String[] args) {
        {
            // Override hashcode but no equals -> can't find (identity equals will always be false)
        ...
        {
            // Override equals but no hashcode -> can't find (new object's identity hashcode will be different than the objects in the map)
...

        {
            ...
            // -> can't find (new object's identity hashcode will be different than the objects in the map)
